                                ...
                                <div class="selectgroup w-100">
                                    ...
                                    <label class="selectgroup-item">
                                        <input type="radio" name="roles" value="STAFF" class="selectgroup-input"
                                            <?php if($user->roles == 'STAFF'): ?> checked <?php endif; ?>>
                                        <span class="selectgroup-button">Staff</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="roles" value="USER" class="selectgroup-input"
                                            <?php if($user->roles == 'USER'): ?> checked <?php endif; ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\_nanda\laravel\laravel10-beckend-kedai1\resources\views/pages/user/edit.blade.php ENDPATH**/ ?>